...
rule run_gridpack:
  ...
  shell:
    ...
    run_gridpack.py --gridpack procs/gridpack_zh-HEL.tar.gz -s 1 -e 500 -p HiggsTemplateCrossSectionsStage1,HiggsTemplateCrossSections -o test-zh
    """
...
rule get_scaling:
  ...
  shell:
    """
    set +u ; pushd /eft2obs ; source /eft2obs/env.sh ; export PATH=${{PATH}}:/eft2obs/scripts ; popd
    python /eft2obs/scripts/get_scaling.py -c config_HEL_STXS.json -i test-zh/Rivet_1.yoda --hist "/HiggsTemplateCrossSections/pT_V" --save json,txt,tex
    """